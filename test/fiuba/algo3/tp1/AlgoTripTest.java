...
public class AlgoTripTest {
	...
	@Test
	public void test10SiNingunViajeFueAgregadoElViajeNoExiste(){
		AlgoTrip algoTrip = new AlgoTrip();
		assertFalse(algoTrip.viajeExiste("UnNombreCualquiera"));
	}
	
	@Test
	public void test11SiSeAgregoUnViajeYSePreguntaSiExisteUnoConOtroNombreEsFalso(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.crearViaje("Vacaciones");
		
		assertFalse(algoTrip.viajeExiste("UnNombreCualquiera"));
	}
	
	@Test
	public void test12SiAgregoUnViajeEsteExiste(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.crearViaje("Vacaciones");
		
		assertTrue(algoTrip.viajeExiste("Vacaciones"));
	}
	
	@Test (expected = ViajeYaExisteError.class)
	public void test13ViajeYaExisteErrorSiIntentoCrearUnViajeQueYaFueCreado(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.crearViaje("Vacaciones");
		algoTrip.crearViaje("Vacaciones");
	}
	
	@Test (expected = ViajeNoExisteError.class)
	public void test14ViajeNoExisteErrorSiAgregoUnVueloEnUnViajeQueNoExiste(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.agregarVueloEnViaje("Vacaciones", "BUE", "COR", "2016-06-01");
	}
	
	@Test (expected = CiudadNoExisteError.class)
	public void test15CiudadNoExisteErrorSiIntentoCrearUnVueloSinCiudadDeLlegada(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.agregarCiudad("BUE", "Buenos Aires", "Argentina", -34.60, -58.38);
		algoTrip.crearViaje("vacaciones-2018");
		algoTrip.agregarVueloEnViaje("vacaciones-2018", "BUE", "COR", "2018-06-01");
	...
	@Test (expected = CiudadNoExisteError.class)
	public void test16CiudadNoExisteErrorSiIntentoCrearUnVueloSinCiudadDeSalida(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.agregarCiudad("COR", "Cordoba", "Argentina", -31.42, -64.18);
		algoTrip.crearViaje("vacaciones-2018");
		algoTrip.agregarVueloEnViaje("vacaciones-2018", "BUE", "COR", "2018-06-01");
	...
	@Test (expected = VueloInvalidoError.class)
	public void test17VueloInvalidoErrorSiPongoMismaCiudadDeLlegadaQueDeSalida(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.agregarCiudad("COR", "Cordoba", "Argentina", -31.42, -64.18);
		algoTrip.crearViaje("vacaciones-2018");
		algoTrip.agregarVueloEnViaje("vacaciones-2018", "COR", "COR", "2018-06-01");
	}
	
	@Test (expected = HotelYaFueAgregadoError.class)
	public void test18HotelYaFueAgregadoErrorSiQuieroAgregarDosVecesElMismoHotel(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.agregarHotel("Copacabana Palace", "RIO", 3000);
		algoTrip.agregarHotel("Copacabana Palace", "RIO", 3000);
	}
	
	@Test (expected = PaqueteYaFueCreadoError.class)
	public void test19PaqueteYaFueCreadoErrorSiQuieroCrearDosVecesElMismoPaquete(){
		AlgoTrip algoTrip = new AlgoTrip();
		algoTrip.agregarPaquete("PaquePlus");
		algoTrip.agregarPaquete("PaquePlus");
	}
